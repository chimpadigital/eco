            ...
            <div class="card-header">
                <div class="row justify-content-between">
                    ...
                    >
                        <div class="icon">
                            <img
                                src="/assets/img/replicadores.svg"
                                class="mb-3"
                                alt=""
                            />
                        </div>
                        <h4 class="card-title">
                            Perfil de:
                            {{
                                data.inforPerfil.nombre +
                                    " " +
                                    data.inforPerfil.apellido
                            }}
                        </h4>
                    </div>
                    <div
                ...
                <div class="row">
                    ...
                    >
                        <div class="input-fecha" style="margin-right:2px;">
                            ...
                            <p style="width: 154px;" class="fechas">
                                {{ data.procesoSesion.primerSesionFecha }}
                            </p>
                            <!-- <input
              class="form-control"
              ...
              />-->
                    ...
                    >
                        <div class="input-fecha" style="margin-right:2px;">
                            ...
                            <p style="width: 154px;" class="fechas">
                                {{ data.procesoSesion.segunSesionFecha }}
                            </p>
                    ...
                    <div class="col-12">
                        <form action="#">
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div
                                    class="col-12 col-sm-6 col-md-3 d-flex align-items-end"
                                >
                                    <!-- <label for="">Apellido</label> -->
                                    <input
                            ...
                            <div class="form-group row justify-content-center">
                                ...
                                <div
                                    class="col-12 col-sm-6 col-md- justify-content-end"
                                >
                                    <label for
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="#">
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-12 col-sm-6 col-md-3">
                                    ...
                                    >
                                        ...
                                        >
                                        <option value="5"
                                            >Sitio Web de la Fundación.</option
                                        >
                                        <option value="6"
                                            >Amig@s o familiares.</option
                                        >
                                        <option value="7"
                                            >Otros (indicar)</option
                                        >
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6 col-md-3">
                                    ...
                                    >
                                        ...
                                        <option value="3">Dificultoso</option>
                                        <option value="4">Lento</option>
                                        <option value="5"
                                            >No tengo comentarios</option
                                        >
                                    </select>
                                </div>
                                <div
                                    class="col-12 col-sm-6 col-md-3 justify-content-end"
                                >
                                    <label for
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-12 col-sm-6 col-md-4">
                                    <label for
                                        ...
                                        decir, sirvió para evacuar dudas?</label
                                    >
                                    <div
                                        class="group-inputs d-flex flex-row align-items-center"
                                    >
                                ...
                                <div class="col-12 col-sm-6 col-md-4">
                                    ...
                                    >
                                    <select
                                        v-model="data.encuestaUser.attention"
                                        type="text"
                                        class="form-control"
                                    >
                                        <option value="1">Elegir opción</option>
                                        ...
                                        <option value="4"
                                            ...
                                            pasada una semana hábil.</option
                                        >
                                        <option value="5"
                                ...
                                <div class="col-12 col-sm-6 col-md-4">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.suggestions"
                                        type="text"
                                        class="form-control"
                                    />
                                </div>
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-12 col-sm-6 col-md-3">
                                    ...
                                    >
                                        ...
                                        >
                                        <option value="5"
                                            >En desacuerdo.</option
                                        >
                                        <option value="6"
                                            >Totalmente en desacuerdo.</option
                                        >
                                    </select>
                                </div>
                                <div
                                    class="col-12 col-sm-6 col-md-3 d-flex flex-column justify-content-between"
                                >
                                    <label for
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <label for
                                        ...
                                        (Eco-ladrillo) del proyecto:</label
                                    >
                                    <select
                                        v-model="
                            ...
                            <div class="form-group row">
                                <div
                                    class="col-12 col-sm-6 col-md-4 d-flex flex-column justify-content-between"
                                >
                                    <label for
                                        >Se detallan todos los pasos a seguir y
                                        la secuencia temporal es detallada,
                                        coherente y factible:</label
                                    >
                                    <select
                                        v-model="
                                ...
                                <div class="col-12 col-sm-6 col-md-4">
                                    <label for
                                        ...
                                        comprensible y significativo:</label
                                    >
                                    <select
                                        v-model="
                            ...
                            <div class="form-group row">
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.chapter_1"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    <label for>Capítulo 2</label>
                                    <input
                                        v-model="data.encuestaUser.chapter_2"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.chapter_3"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.chapter_4"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.chapter_5"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.chapter_6"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.chapter_7"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                                <div class="col-6 col-sm-1 mb-3 mb-lg-0">
                                    ...
                                    <input
                                        v-model="data.encuestaUser.chapter_8"
                                        type="text"
                                        class="form-control capitulo"
                                    />
                                </div>
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-12 col-sm-6 col-md-4">
                                    <div class="inputs">
                                        ...
                                        >
                                            <option value="1"
                                                >Elegir opción</option
                                            >
                                            <option value="2"
                                                >Muy satisfecho/a.</option
                                            >
                                            <option value="3"
                                                >Satisfecho/a.</option
                                            >
                                            ...
                                            <option value="5"
                                                >Insatisfecho/a.</option
                                            >
                                            <option value="6"
                                                >Muy insatisfecho/a.</option
                                            >
                                        </select>
                                    </div>
                                    <div class="inputs mt-3">
                                        ...
                                        >
                                            ...
                                            >
                                            <option value="2"
                                                >Definitivamente si.</option
                                            >
                                            <option value="3"
                                                >Probablemente si.</option
                                            >
                                            <option value="4">No lo sé.</option>
                                            <option value="5"
                                                >Probablemente no.</option
                                            >
                                            <option value="6"
                                                >Seguramente no.</option
                                            >
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-4">
                                    ...
                                    >
                                    <textarea
                                        v-model="data.encuestaUser.like"
                                        class="form-control"
                                        rows="5"
                                    ></textarea>
                                </div>
