    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-2 d-flex flex-column">
          ...
          <input type="date" name="primer_sesion" id="primer_sesion" />
        </div>
        <div class="col-12 col-sm-6 col-md-2 d-flex flex-column">
          <label for="segunda_sesion">Segunda Sesión</label>
          <input type="date" name="segunda_sesion" id="segunda_sesion" />
        </div>
        <div class="col-12 col-sm-6 col-md-2 d-flex flex-column">
          <label for="condiciones_uso">Condiciones Generales de Uso</label>
          <input type="checkbox" name="condiciones_uso" id="condiciones_uso" />
        </div>
        <div class="col-12 col-sm-6 col-md-2 d-flex flex-column">
          <label for="acuerdo_confidencialidad">Acuerdo de Confidencialidad</label>
          <input type="checkbox" name="acuerdo_confidencialidad" id="acuerdo_confidencialidad" />
        </div>
        <div class="col-12 col-sm-6 col-md-2 d-flex flex-column">
          ...
          <form action="#">
            ...
            <div class="form-group row justify-content-center">
              <div class="col-12 col-sm-6 col-md-3">
                ...
                <input v-model="data.inforPerfil.fechaNacimiento" type="date" class="form-control" />
              </div>
              <div class="col-12 col-sm-6 col-md-3">
              ...
              <div class="col-12 col-sm-6 col-md-3">
                ...
                <input v-model="data.inforPerfil.pais" type="text" class="form-control" />
              </div>
              <div class="col-12 col-sm-6 col-md-3">
            ...
            <div class="form-group row justify-content-center">
              ...
              <div class="col-6 col-sm-6 col-md-3">
                <label for="ong">Implementación anterior de proyectos</label>
                <div class="group-inputs d-flex flex-row align-items-center">
                  <input
                    v-model="
            ...
            <div class="form-group row justify-content-center">
              ...
              <div class="col-12 col-sm-6">
                ...
                <input v-model="data.informacionExtra" type="text" class="form-control" placeholder />
              </div>
            </div>
