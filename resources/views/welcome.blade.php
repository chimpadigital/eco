                            ...
                            <div class="box-form">
                                ...
                                <div class="col p-0">
                                    <div class="form-group mt-4">
                                        <input type="text" class="form-control input-custom" placeholder="Nombre">
                                    </div>
                                </div>
                                <div class="col p-0">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-custom" placeholder="Apellido">
                                    </div>
                                </div>
                                <div class="col p-0">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control input-custom" placeholder="Correo Electrónico">
                                    </div>
                                </div>
                                <div class="col p-0">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-custom" placeholder="Teléfono">
                                    </div>
                                </div>
                                <div class="col p-0">
                                    <div class="form-group">
                                        <input type="text" class="form-control input-custom" placeholder="Ciudad">
                                    </div>
                                </div>
                                <div class="col p-0">
                                    <select class="custom-select">
                                        <option selected  name="pais">País de residencia</option>
