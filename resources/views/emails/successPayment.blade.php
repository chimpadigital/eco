...
<base target="_blank">
<title>Announce Email Template</title>
<style type="text/css">
...
<style type="text/css">@media only screen and (max-width: 640px){
		...
		body table[class=mobile2] {width: 100%!important; padding-left: 20px; padding-right: 20px; clear: both; }
		body table[class=fullCenter2] {width: 100%!important; text-align: center!important; clear: both; }
		body td[class=fullCenter2] {width: 100%!important; text-align: center!important; clear: both; }
									...
									<table width="600px" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile">
										<tbody><tr>
											<td width="600px" valign="middle" align="center">
												...
												<table width="500px" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
													<tbody><tr>
														<td align="center" valign="middle" width="500px" style="text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 26px; color: #80C342; line-height: 34px; font-weight: 600px;" class="fullCenter">
															@lang('emails.email_1.title_1')
														</td>
													</tr>
												</tbody></table>
										...
										<tbody><tr>
											<td width="600px" valign="middle" align="center">
												...
												<table width="500px" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
													<tbody>
														<tr>
															<td valign="middle" width="500px" style="text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #333; line-height: 24px;" class="fullCenter">
																@lang('emails.email_1.p_1')
															</td>
														</tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" align="center">
													<tbody><tr>
														<td align="center" height="38" bgcolor="#80C342" style="border-top-left-radius: 45px; border-top-right-radius: 45px; border-bottom-right-radius: 45px; border-bottom-left-radius: 45px; padding-left: 25px; padding-right: 25px; font-weight: 600; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff; background-color: #80C342; font-size: 14px;">
															<a href="{{route('steps')}}" target="_blank" style="color: #ffffff; font-size: 14px; text-decoration: none; line-height: 34px; width: 100%;">@lang('emails.email_1.btn')</a>
														</td>
													</tr>
												</tbody></table>
