...
class gCalendarController extends Controller
{
    ...
    public function index()
    {
        ...
        // $client->setAuthConfig('client_secret.json');
        // $client->setDeveloperKey("AIzaSyC2gm8LCyEF3KB_damFaO--sUvKOIij5H4");
        ...
        $calendarId = 'primary';
            ...
            return $results = $service->events->listEvents($calendarId);
        ...
        // if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
            $this->client->setAccessToken('a4fddfac27c027d2e2817de1109b95e0d1281b1b');
